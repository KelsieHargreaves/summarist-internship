...
import Forgot from "./Modal/forgotModal";
...
const SideBar = ({ onLogin }) => {
  ...
  const { isGuest, logoutGuest, showModal, logout } = useModal()
  ...
  try {
    if (isGuest) {
      ...
      logout()
      console.log("NextAuth user logged out")
    }
    } catch (error) {
  ...
  return (
    <div id="SideBar">
      ...
      <div className="NavTop">
        <Link href={'/ForYou'} className="ForYouButton">
          <svg
            stroke="currentColor"
            fill="currentColor"
            strokeWidth="0"
        ...
        <Link href={'/Library'} className="LibraryButton">
          <svg
            stroke="currentColor"
            fill="currentColor"
            strokeWidth="0"
      ...
      <div className="NavBottom">
        ...
        <button onClick={handleLogout} className="LogoutButton">
          ...
          <> 
          <button onClick={onLogin} className="LogoutButton">
              <svg
            stroke="currentColor"
            fill="none"
            strokeWidth="2"
