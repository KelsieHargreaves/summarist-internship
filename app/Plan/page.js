    ...
    <div>
      <div className="planContainer">
        <div className="planHeader">
          ...
          <img src="/pricing-top.png" />
        </div>
        <div className="planRow">
          <div className="planDescriptions">
          ...
          <div className="planFaqs">
            <div className="planFaq">
              ...
              >
                ...
                <span className={`caret ${open1 ? "open" : ""}`}>▸</span>
              </h1>
              {open1 && (
                <p>
            ...
            <div className="planFaq">
              ...
              >
                ...
                monthly?{" "}
                <span className={`caret ${open2 ? "open" : ""}`}>▸</span>
              </h1>
              {open2 && (
                <p>
            ...
            <div className="planFaq">
              ...
              >
                ...
                <span className={`caret ${open3 ? "open" : ""}`}>▸</span>
              </h1>
              {open3 && (
                <p>
